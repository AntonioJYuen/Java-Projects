 ...
 * text, compare files using plain text or pixel by pixel comparison, extract
 * all the images from the pdf
 *
...
public class PDFUtil {
	 ...
	 * 
	 * @param colorCode
	 *            color code to highlight the difference
	 */
	...
	/**
	 * To compare all the pages of the PDF files. By default as soon as a
	 * mismatch is found, the method returns false and exits.
	 * 
	 * @param flag
	 *            true to enable; false otherwise
	 */
	 ...
	 * formatting. <b>VISUAL_MODE</b> : Compare 2 pdf documents pixel by pixel
	 * for the content and format.
	 * 
	 * @param file1
	 *            Absolute file path of the expected file
	 * @param file2
	 *            Absolute file path of the actual file
	 ...
	 * @param endPage
	 *            Ending page number of the document
	 * @param highlightImageDifferences
	 *            To highlight differences in the images
	 * @param showAllDifferences
	 *            To compare all the pages of the PDF (by default as soon as a
	 *            mismatch is found in a page, this method exits)
	 * @return boolean true if matches, false otherwise
	 * @throws java.io.IOException
	 *             when file is not found.
	 */
	...
	/**
	 * This method reads each page of a given doc, converts to image compare. If
	 * it fails, exits immediately.
	 */
